...
public class CommonConstants {
    // frame Config   
    public static final Dimension GUI_SIZE = new Dimension(500, 600);

    // banner config 
    public static final Dimension BANNER_SIZE = new Dimension(GUI_SIZE.width, 40);
    
    // task panel config
    public static final Dimension TASKPANEL_SIZE = new Dimension(GUI_SIZE.width - 30, GUI_SIZE.height - 150);
    ...
    public static final Dimension CHECKBOX_SIZE = new Dimension((int) (TASKFIELD_SIZE.width * 0.85), 50);
